...
const AboutUs = () => {
    return (
        <div className='container mx-auto'>
            ...
            <div className='flex justify-center flex-col-reverse md:flex-row gap-[2%] items-center my-10 py-4'>
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className='md:w-[49%] w-full text-right'>
